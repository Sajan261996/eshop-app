...
const Home = ({ products: initialProducts, searchTerm }) => {
  ...
  const dummyProducts = [
    ...
    },
    {
      ...
      stock: 70,
      rating: 4.1,
      description: "Pack of 3 cotton t-shirts in assorted colors.",
      image: img8,
    },
    {
      id: 9,
    ...
    },
    {
      ...
      stock: 40,
      rating: 4.5,
      description: "Non-slip yoga mat made with eco-friendly material.",
      image: img14,
    },
    {
      id: 15,
